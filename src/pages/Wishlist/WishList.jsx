...
import GetAllWishList from "../../components/Fetchings/Functions/GetAllWishList";
...
function WishList() {
  ...
  return (
    Items && (
      <div className="p-2">
        <p className="my-3 text-center text-2xl border-b-2 p">Your wishlist</p>
        <div className="flex flex-wrap items-center">
          {Items.map((item) => (
            <div class="relative m-3 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100  shadow-md">
              <Link
