...
function SearchingPageItems({ Items }) {
    ...
    Items && (
      <div>
        <div className="flex gap-4 flex-wrap items-center">
          {Items.map((item) => (
            <div class="relative m-1 sm:m-3 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100  shadow-md">
              <Link
...
export default SearchingPageItems;
